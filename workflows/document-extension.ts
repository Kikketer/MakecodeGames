...
async function buildCommitFilesStep(
  ...
  // 2. The JSON for the beta comparison route
  files.push({
    path: `content/extensions-generated/${doc.owner}/${doc.repo}.json`,
    content: JSON.stringify(doc, null, 2),
  });

  // 3. Updated index.ts — fetch current from repo, apply update
...
### Review
Compare the AI-generated docs with the hand-written ones at [/extensions-beta/${extensionOwner}/${extensionRepo}](/extensions-beta/${extensionOwner}/${extensionRepo}) before merging.`;
